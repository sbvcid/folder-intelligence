...
pub use agent::{
    ...
    GapType, Goal, IntentParseError, LogEntry, OperationExecutionState, OperationLog, OperationPlan,
    Pipeline, PipelineError, PipelineOptions, PipelineResult, PlanError, PlanGenerator,
    PlanPreview, PlanValidationContext, PlanValidator, Policy, PolicyDecision, ProposedCategory,
