...
pub use agent::{
    ...
    ProposalRefinementError, ProposalRefinementParser, ProposalRefiner, ProposedCategory,
    ...
    UndoLogEntry, UndoResult, UnresolvedItem, UnresolvedReason, UserDecision, ValidatedOperation,
    ValidationResult, ValidationStatus, ValidationSummary, ValidationWarning, VerificationCheck,
    VerificationStatus, VerificationSummary, WarningType,
};
