...
pub use agent::{
    ...
    PolicyDecision, Precondition, ProposalConversionResult, ProposalConverter, ProposedCategory,
    ...
    TaskIntent, TaskIntentParser, UndoConflict, UndoLogEntry, UndoResult, UnresolvedItem,
    UnresolvedReason, UserDecision, ValidatedOperation, ValidationResult, ValidationStatus,
