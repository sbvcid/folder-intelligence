...
pub use agent::{
    ...
    PolicyDecision, Precondition, ProposalConversionResult, ProposalConverter, ProposalRefinement,
    ProposalRefinementError, ProposalRefinementParser, ProposalRefinementService, ProposalRefiner,
    ProposedCategory, ProposedOperation, Recommendation, RecommendationEngine, RecommendationError,
    RecommendationStrategy, RecommendationWarning, RefinementParseError, RefinementParseOutput,
    RefinementServiceError, ScopeLock, StructureSummary, TaskAnalysis, TaskIntent,
    TaskIntentParser, UndoConflict, UndoLogEntry, UndoResult, UnresolvedItem, UnresolvedReason,
    UserDecision, ValidatedOperation, ValidationResult, ValidationStatus, ValidationSummary,
    ValidationWarning, VerificationCheck, VerificationStatus, VerificationSummary, WarningType,
};
