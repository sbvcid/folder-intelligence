...
pub use agent::{
    ...
    PolicyDecision, Precondition, ProposalConverter, ProposedCategory, ProposedOperation,
    Recommendation, RecommendationEngine, RecommendationError, RecommendationStrategy,
    RecommendationWarning, ScopeLock, StructureSummary, TaskAnalysis, TaskIntent, TaskIntentParser,
    UndoConflict, UndoLogEntry, UndoResult, UnresolvedItem, UnresolvedReason, UserDecision,
    ValidatedOperation, ValidationResult, ValidationStatus, ValidationSummary, ValidationWarning,
    VerificationCheck, VerificationStatus, VerificationSummary, WarningType,
};
